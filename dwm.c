...
enum { SchemeNorm, SchemeSel, SchemeNMaster}; /* color schemes */
...
// TODO err
	...
	char nmmaster_str[3];
	sprintf(nmmaster_str, "%d", m->nmaster);
	w = blw = TEXTW(nmmaster_str);
	x = drw_text(drw, x, 0, w, bh, lrpad /2 , nmmaster_str, 0);
